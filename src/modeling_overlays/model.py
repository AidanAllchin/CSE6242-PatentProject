...
1. Load the training data:
    - `training_data.tsv` generated by `generate_predictors.py`
    - Splits 2022 data out, as it has no `next_innovation_score`
2. Train the model
3. Generate predictions for 2022
...
def generate_predictions_file(input_path: str, output_path: str):
    ...
    # Drop unnecessary columns (these are all scaled anyways so useless for our overlay)
